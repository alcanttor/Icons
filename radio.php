<div class="rmagic-field">
    <label class="rmfield" for="form_6_1-element-35" style="">Gender</label>
    <div class="rminput">
        <ul class="rmradio">
            <li>
    ...
    <div class="rmnote" style="background-color: rgb(1, 112, 185); width: 71.453125px; top: 108px; display: none;"><div class="rmprenote" style="border-bottom-color: rgb(1, 112, 185);"></div>
        <div class="rmnotecontent">Select Your Gender</div>
    </div>
</div>